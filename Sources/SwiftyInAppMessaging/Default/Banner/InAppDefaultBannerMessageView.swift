    ...
    final class InAppDefaultBannerMessageView: UIView {
        ...
        init(
            ...
            if let image = image {
                ...
                self.bannerImage.heightAnchor.constraint(
                    equalTo: self.bannerImage.widthAnchor, multiplier: 1.0
                ).isActive = true
            } else {
            ...
            NSLayoutConstraint.activate([
                ...
                self.titleLabel.leftAnchor.constraint(
                    equalTo: self.bannerImage.rightAnchor, constant: 16),
            ...
            NSLayoutConstraint.activate([
                self.bodyLabel.topAnchor.constraint(
                    equalTo: self.titleLabel.bottomAnchor, constant: 4),
                self.bodyLabel.leftAnchor.constraint(
                    equalTo: self.bannerImage.rightAnchor, constant: 16),
